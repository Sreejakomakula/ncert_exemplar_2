...
\begin{align}
         p_{X_2}\brak{k} = 
                           \begin{cases}
                                   \frac{25}{51}, & \text{both have same colour} \quad {k=0,1}\\
                                   \frac{26}{51}, & \text{both have different colour} \quad {k=0,1}
                           \end{cases}
\end{align}                   
Probabilty that both cards have different colour:\\
\begin{align}
p(\text{different colours}) &= p(X_2=0 | X_1=1) + p(X_2=1 | X_1=0)\\
